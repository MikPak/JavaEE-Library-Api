...
public class RestClient {
    ...
    public static final String SERVER_URL = "http://localhost:8080/task3/api";
    ...
    public static String doPost(final String url, final String POSTText)
        ...
        BasicHeader authHeader = new BasicHeader("Authorization","admin:YWRtaW46YWRtaW5wc3c=");
