...
{
    public static final String SERVER_URL = "http://localhost:8080/library";
    @UserAuth
    @GET
    @Path("/bookshelf/all")
    ...
    @Path("/bookshelf/")
    @Produces(MediaType.APPLICATION_JSON)
    public Response addBookshelf(@FormParam("booktype") String booktype) throws URISyntaxException
    {
        ...
        {
        	java.net.URI location = new java.net.URI(SERVER_URL);
